            ...
            >
                ...
                <div className="p-8 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto flex flex-col gap-3 text-center">
                        ...
                        <Link href="/live-jobs" className="w-full text-gray-600 font-semibold py-3 rounded-xl border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all duration-300">
                            View Job Openings
                        </Link>
                    </div>
