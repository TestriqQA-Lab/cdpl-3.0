...
import { TrendingUp, ArrowRight, Sparkles, Target, Briefcase, DollarSign, Award, BarChart3, Users, Building2, Rocket, CheckCircle } from "lucide-react";
...
const CareerCard = ({ path, index }: { path: CareerPath; index: number }) => {
    ...
    // fallback color if demandLevel isn't one of the three recognized keys
    const demandClass = demandColors[path.demandLevel] ?? "bg-gray-100 text-gray-700 border-gray-200";
                ...
                <div className="p-8 flex flex-col flex-grow">
                    ...
                    <div className="flex items-start justify-between mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            >
                                <Briefcase className={`w-7 h-7 ${theme.iconColor}`} strokeWidth={2.5} />
                            </motion.div>
                        </div>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-sm font-semibold text-gray-600">{path.experience} Experience</span>
                    </div>
            ...
            <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                    {(careerPathContent.paths as Partial<CareerPath>[]).map((p, index) => {
                        ...
                        return <CareerCard key={`${full.id}-${full.role}-${index}`} path={full} index={index} />;
                    })}
                </div>
