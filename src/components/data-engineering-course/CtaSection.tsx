  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute inset-x-0 top-0 h-[140px] bg-[radial-gradient(600px_120px_at_50%_0%,rgba(20,184,166,0.10),transparent_60%)]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-7 grid grid-cols-1 gap-3 sm:grid-cols-3 max-w-4xl mx-auto">
          ...
          <KPI label="Outcome" value="Job-Ready Portfolio" note="Pipelines • DAGs • Lakehouse" accent="text-rose-700 bg-rose-50" />
        </div>
