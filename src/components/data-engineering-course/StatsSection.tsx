...
// Server component — clean, modern, responsive stats with subtle futuristic accents (Big Data edition).
...
export default function StatsSection() {
  ...
  return (
    <section
      id="bde-stats"
      aria-labelledby="bde-stats-heading"
      className="relative py-2 md:py-8 bg-white"
    >
      {/* Subtle futuristic backdrop (fine grid + soft top glow; no heavy gradients) */}
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(2,6,23,0.035)_1px,transparent_1px),linear-gradient(to_bottom,rgba(2,6,23,0.035)_1px,transparent_1px)] bg-[size:28px_28px]" />
        <div className="absolute inset-x-0 top-0 h-[110px] bg-[radial-gradient(700px_140px_at_50%_0%,rgba(20,184,166,0.10),transparent_60%)]" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 text-base md:text-lg leading-relaxed text-slate-700">
            ...
            <strong>batch & streaming pipelines</strong> using <strong>Apache Spark</strong>,{" "}
            <strong>Kafka</strong>, <strong>Hadoop</strong>, <strong>Airflow</strong>, and cloud data platforms.
          </p>
        ...
        <div className="mx-auto mt-8 max-w-4xl rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm">
          <p className="text-sm text-slate-700">
            Practice on <strong>real datasets</strong> with <strong>orchestration</strong>,{" "}
            <strong>observability</strong>, and <strong>cost-aware design</strong> for roles like{" "}
