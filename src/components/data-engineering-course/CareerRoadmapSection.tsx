...
const STEPS: Step[] = [
  {
    n: 1,
    title: "Complete the 95-Hour Big Data Hero Program",
    desc:
  ...
  {
    n: 2,
    title: "Build 3 Enterprise-Grade Pipelines",
    desc:
  ...
  {
    n: 3,
    title: "Cloud Deployments & Cost-Safe Scaling",
    desc:
  ...
  {
    n: 4,
    title: "Career Prep • Interviews • Offers",
    desc:
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute inset-x-0 top-0 h-[140px] bg-[radial-gradient(700px_160px_at_50%_0%,rgba(13,148,136,0.10),transparent_60%)]" />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <header className="text-center max-w-3xl mx-auto">
          ...
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <KPI label="Program Duration" value="~ 10–12 Weeks" note="95 hours guided learning" />
            <KPI label="Portfolio Pipelines" value="3+" note="Batch & streaming" />
            <KPI label="Target CTC" value="₹12–20 LPA" note="Role & location vary" />
          </div>
        </header>
          ...
          <div className="space-y-6">
            {STEPS.map((s, i) => (
              ...
              >
                ...
                {/* Card (zig-zag on desktop for visual rhythm) */}
                <article
                  tabIndex={0}
                  className={[
        ...
        <div className="mt-12 text-center">
          <Link
            ...
            aria-label="Get personalized big data roadmap guidance"
          >
          ...
          <p className="mt-3 text-xs sm:text-sm text-slate-600">
            Learn from anywhere. <span className="font-semibold text-slate-800">Your journey to a Big Data career starts here.</span>
          </p>
        </div>
      </div>
