...
// Server component — clean, modern, responsive stats with subtle futuristic accents (Data Science & ML edition).
...
export default function StatsSection() {
  ...
  return (
    ...
    >
      {/* Subtle futuristic backdrop (fine grid + soft purple glow; no heavy gradients) */}
