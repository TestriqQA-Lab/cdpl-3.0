...
const STEPS: Step[] = [
  {
    n: 1,
    title: "Complete the 200-Hour Data Science Masterclass",
    desc:
...
export default function CareerRoadmapSection() {
  ...
  const jsonLd = {
    ...
    "@type": "HowTo",
    name: "Data Science Career Roadmap",
    description:
      "Step-by-step roadmap to become a job-ready Data Science/ML professional with portfolio projects, interview prep, and placement support.",
    totalTime: "P3M",
    step: STEPS.map((s) => ({
      "@type": "HowToStep",
      position: s.n,
    ...
    keywords:
      "data science career roadmap, machine learning jobs india, data scientist salary, ml engineer path, portfolio projects, mlops deployment",
  };
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute inset-x-0 top-0 h-[140px] bg-[radial-gradient(700px_160px_at_50%_0%,rgba(147,51,234,0.10),transparent_60%)]" />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <header className="text-center max-w-3xl mx-auto">
          ...
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <KPI label="Program Duration" value="~ 10–12 Weeks" note="200 hours guided learning" />
