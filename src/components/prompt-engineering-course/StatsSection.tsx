...
// Server component — clean, modern, responsive stats with subtle futuristic accents (Prompt Engineering edition).
...
const STATS: Stat[] = [
  {
    ...
    hint: "Prompt patterns • Guardrails",
    accent: {
      bar: "bg-emerald-500",
  ...
  },
  {
    ...
    hint: "Verifiable • Portfolio-ready",
    accent: {
      bar: "bg-sky-500",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base md:text-lg leading-relaxed text-slate-700">
            Unlock the power of <strong>LLMs</strong> with proven <strong>prompt patterns</strong>,{" "}
            <strong>guardrails & safety</strong>, and <strong>evaluation</strong>. Build automation
            that ships—fast.
          </p>
