...
export const content = {
    ...
    sections: [
      ...
      <p>Think of it this way: <em>AI is the goal</em>, <em>ML is a set of techniques</em>, and <em>Data Science is the process and practice around data driven decisions</em>.</p>`,
            image: "/blog/section/ds-ml-ai-definitions.png"
        },
        {
      ...
      <ul>
        ...
        <li><strong>Data Science ↔ AI:</strong> AI features still require analytics, monitoring, and A B tests to measure impact.</li>
            ...
            image: "/blog/section/ds-ml-ai-overlap.png"
        },
        {
        ...
        <tbody>
          <tr>
            <td>Primary goal</td>
            <td>Insights and decisions</td>
            <td>Predictions from data</td>
            <td>Human like intelligent behavior</td>
          </tr>
          <tr>
            <td>Typical outputs</td>
            <td>Reports, dashboards, experiments, baseline models</td>
            <td>Trained models, features, evaluation metrics</td>
            <td>Agents, assistants, perception and planning systems</td>
          </tr>
          <tr>
            <td>Core skills</td>
            <td>SQL, statistics, visualization, communication</td>
            <td>Feature engineering, model tuning, MLOps basics</td>
            <td>Reasoning, search, prompts, multimodal inputs, safety</td>
          </tr>
          <tr>
            <td>Common tools</td>
            <td>Python, pandas, SQL, BI tools</td>
            <td>Scikit learn, XGBoost, PyTorch, TensorFlow</td>
            <td>LLM frameworks, vector DB, RL, orchestration</td>
          </tr>
          <tr>
            <td>Example use</td>
            <td>Revenue analysis by region</td>
            <td>Churn prediction model</td>
            <td>Chat assistant that answers support queries</td>
          </tr>
        </tbody>
      </table>`,
            image: "/blog/section/ds-ml-ai-table.png"
        },
        {
        ...
        <li><strong>Learning platform at CDPL:</strong> data science tracks learner progress, ML recommends lessons, AI tutors explain concepts with step by step hints.</li>
            ...
            image: "/blog/content/ds-ml-ai-examples.jpg"
        },
        {
      ...
      <ul>
        ...
        <li><strong>Tools:</strong> vector databases, orchestration frameworks, evaluation harness, latency and cost analysis.</li>
            ...
            image: "/blog/section/ds-ml-ai-skills-tools.png"
        },
        {
...
print("AUC:", roc_auc_score(y_te, pred))</code></pre>
        <p class="code-caption">ML focuses on predictive performance and validation</p>
            ...
            image: "/blog/content/ds-ml-ai-workflows.jpg"
        },
        {
      ...
      <p>Most products blend all three. Start with data science to frame the problem, use ML for prediction, and add AI for interactive experiences.</p>`,
            image: "/blog/section/ds-ml-ai-when-to-use.png"
        },
        {
      ...
      <p>Whichever path you choose, keep a clean portfolio with READMEs that state the problem, data, method, results, and a single compelling chart or demo.</p>`,
            image: "/blog/section/ds-ml-ai-study-paths.png"
        },
        {
            title: "FAQ",
      ...
      <p><strong>Can one person do all three</strong> In small teams yes. In larger teams roles specialize to move faster and scale safely.</p>`,
            image: "/blog/section/ds-ml-ai-faq.png"
        }
    ],
